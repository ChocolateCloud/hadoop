...
/**
 * A Reed-Solomon raw encoder using ChocolateCloud-RS library.
 */
@InterfaceAudience.Private
public class NativeChocolateCloudRSRawEncoder extends AbstractNativeRawEncoder {

    static {
        ErasureCodeChocolateCloudRS.checkNativeCodeLoaded();
    }

    public NativeChocolateCloudRSRawEncoder(ErasureCoderOptions coderOptions) {
        super(coderOptions);
